...
public class SQLCommand {
    ...
    // CREATE TABLE
    public static final String CREATE_EVENT_TABLE = "CREATE TABLE " + todoEvent + "(eid VARCHAR2(50) NOT NULL, title VARCHAR2(40), duedate VARCHAR2(10), duetime VARCHAR2(8), timeneed int, userid VARCHAR2(50), PRIMARY KEY(eid), FOREIGN KEY (userid) REFERENCES " + user +"(uuid))";
    ...
    public static final String CREATE_SCHEDULED_TABLE = "CREATE TABLE "+ scheduledEvent + "(sid VARCHAR2(50) NOT NULL, title varchar2(40), color varchar2(7), starttime varchar2(19), endtime varchar2(19), userid VARCHAR2(50), PRIMARY KEY(sid), FOREIGN KEY(userid) REFERENCES " + user + "(uuid))";
}
