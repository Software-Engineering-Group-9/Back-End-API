...
public class SQLCommand {
    ...
    public static final String BusyScheudled = "BusyScheudled6";
    ...
    public static final String BUSY_INSERT = "INSERT INTO " + BusyScheudled + " VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public static final String CREATE_AVAILABILITY_TABLE = "CREATE TABLE " + BusyScheudled + "(aid VARCHAR2(100) NOT NULL, title varchar2(40), start_time varchar2(19), end_time varchar2(19), Color varchar2(7), userid varchar2(50), PRIMARY KEY(aid), FOREIGN KEY (userid) REFERENCES " + user + "(uuid))";
